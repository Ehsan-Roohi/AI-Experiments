...
**[Watch the videos and open the live HTML animations](https://ehsan-roohi.github.io/AI-Experiments/pelican-flight/)**
...
These are three retained code specimens produced sequentially in one conversation, with earlier outputs visible in context and some tool-assisted checks during creation. They are not blind, independent, single-shot trials. The assistant did not independently verify the backend model or reasoning settings. The first animation is labeled Ultra High as reported by the user. No ranking or general model-performance claim is made.
